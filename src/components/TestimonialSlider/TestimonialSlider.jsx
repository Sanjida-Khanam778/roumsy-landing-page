...
const TestimonialSlider = () => {
  ...
  return (
    <div className="relative z-10 bg-[#F9FAFB] py-16">
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute hidden 2xl:block top-0 sm:top-10 lg:-top-40 right-0 sm:right-0 lg:-right-16 w-[320px] h-[320px] sm:w-[420px] sm:h-[420px] lg:w-[320px] lg:h-[320px] rounded-full border-[10px] sm:border-[12px] lg:border-[36px] border-circle/50 z-0"
