...
export default function Plan() {
  return (
    <div className="mx-auto p-6 h-[91vh] overflow-auto bg-[#F4F8FD]">
      ...
      {/* Table Header */}
      <div className="bg-blue-100 border border-blue-200 rounded-t-lg p-4 max-w-4xl mx-auto">
      ...
      {/* Table Content */}
      <div className="bg-white border border-blue-200 border-t-0 rounded-b-lg p-4 max-w-4xl mx-auto">
        <div className="grid grid-cols-4 gap-4 items-center">
          ...
          <div className="flex gap-2">
            <Button rounded="md" padding="px-4 py-1">
              Change
            </Button>
            <Button rounded="md" padding="px-4 py-1">
              Delete
